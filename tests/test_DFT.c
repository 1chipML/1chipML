...
static int knownTestingDFT(const unsigned length,
  fft_real* inputReals,
...
static int knownTestingDFTI(const unsigned length,
  fft_real* inputReals,
  fft_real* inputImaginaries,
  fft_real* expectedReals, 
  fft_real* expectedImaginaries) {
...
int main() {
  ...
  returnCode |= knownTestingDFT(length, DFTinputReals, DFTinputImgs, DFTexpectedReals, DFTexpectedImgs);
  ...
  returnCode |= knownTestingDFTI(length, DFTIinputReals, DFTIinputImgs, DFTIexpectedReals, DFTIexpectedImgs);
